...
export default function TutorialVideoPlayer({
    ...
    useEffect(() => {
        ...
        // Filter by search query (also search router model names)
        if (searchQuery) {
        ...
        // Sort by most viewed or popular if available
        if (filtered.length > 0 && "views" in filtered[0]) {
    ...
    // Find the most viewed router configuration video
    const mostViewedRouterVideo = videos
        .filter(
            (v) =>
                (v.category?.toLowerCase().includes("router") ||
                    v.title?.toLowerCase().includes("router")) &&
        ...
        <div className="space-y-6">
                    ...
                    <CardContent>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-2 flex flex-wrap gap-1">
                                {selectedVideo.routerModels.map(
                                    (model, index) => (
                                        <Badge
                                            key={index}
                                            variant="secondary"
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div className="space-y-4 mb-6">
                        <div className="flex gap-4">
                            ...
                            <Select
                                ...
                                onValueChange={setSelectedRouterModel}
                            >
                                <SelectTrigger className="w-48">
                    ...
                    {/* Most Viewed Router Video */}
                    {mostViewedRouterVideo && (
                        <div className="mb-8">
                            <Card className="border-2 border-yellow-400 bg-yellow-50">
                                <CardHeader className="flex flex-row items-center justify-between">
                                    ...
                                    <Badge className="bg-yellow-400 text-yellow-900">
                                        {mostViewedRouterVideo.views?.toLocaleString()}{" "}
                                        views
                                    </Badge>
                                </CardHeader>
                                <CardContent>
                                    <div className="flex flex-col md:flex-row gap-4 items-center">
                                            ...
                                            <div className="aspect-video bg-black rounded-lg overflow-hidden">
                                                <iframe
                                                    src={getVideoEmbedUrl(
                                                        mostViewedRouterVideo.videoUrl
                                                    )}
                                                    title={
                                                        mostViewedRouterVideo.title
                                                    }
                                                    className="w-full h-full"
                                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                                    allowFullScreen
                                        ...
                                        <div className="w-full md:w-1/2 flex flex-col gap-2">
                                            ...
                                            <p className="text-sm text-yellow-900">
                                                {
                                                    mostViewedRouterVideo.description
                                                }
                                            </p>
                                            <div className="flex flex-wrap gap-1 mt-2">
                                                {mostViewedRouterVideo.routerModels.map(
                                                    (model, idx) => (
                                                        <Badge
                                                            key={idx}
                                                            variant="secondary"
                                            ...
                                            <Button
                                                className="mt-2 bg-yellow-500 hover:bg-yellow-600 text-yellow-900"
                                                onClick={() =>
                                                    handleVideoSelect(
                                                        mostViewedRouterVideo
                                                    )
