                ...
                <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow rounded-lg sm:px-10 transition-colors duration-200">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            ...
                            <select
                                {...register("role")}
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 transition-colors duration-200"
                            >
                                <option value="USER">Standard User</option>
                                <option value="ADMIN">Administrator</option>
                            </select>
                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                Standard users can access all tools. Administrators have additional management capabilities.
                            </p>
                            {errors.role && (
