        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 shadow rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
                        ...
                        >
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full border border-green-100 rounded-xl px-4 py-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-green-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-green-400"
                                    required
                                />
                            </div>
                            <div>
